...
from graph_construct2 import tfidf_kw_extract, wiki_spacy_extract, \
...
if __name__ == "__main__":
    ...
    test_docs = json.load(open('./{}/{}'.format(args.dataset,args.file_path), 'r'))
    ...
    if args.kg == 'TF-IDF':
        ...
        pkl.dump(test_docs,open('./{}/tagme_graph.pkl'.format(args.dataset),'wb'))
        test_docs_graphs = kw_process_graph(test_docs)
